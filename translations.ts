export const translations = {
  ...
  ja: {
    ...
    // About
    aboutTitle: 'ABOUT',
    aboutIntro: 'はピアニスト、作曲家、メディアアーティスト、CGアーティスト。',
  ...
  zh: {
    ...
    // About
    aboutTitle: 'ABOUT',
    aboutIntro: '是一位鋼琴家、作曲家、媒體藝術家與 CG 藝術家。',
    ...
    aboutP3: '他的才華在國際上備受肯定，作品由美國與英國廠牌發行。他為英國藝術團體 Random International 在利雅德燈光節（全球最大燈光節）的裝置提供音樂與空間音響。此外，他贏得世界級創作者的信任，包括電影導演阿比查邦・韋拉斯塔古，曾受邀於大學工作坊進行特別講座。',
