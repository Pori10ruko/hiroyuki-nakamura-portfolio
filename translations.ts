export const translations = {
  en: {
    ...
    aboutP3: 'Releases include Piano Distance (Fluid Audio, UK / Beyond Boundary Music, 2026) — its title answering Toru Takemitsu\'s 1961 solo piano piece, extending ma, the charged interval between sounds, into literal space — Sen no Tsudoi (Dragon\'s Eye, 2024), and Look Up at the Stars (Youngbloods, 2023). He lectures at the National University of Tainan (Taiwan) and at ESP Entertainment Tokyo, and joined Apichatpong Weerasethakul\'s workshop at Tama Art University as an instructor.',
  ...
  ja: {
    ...
    aboutP3: '作品に『Piano Distance』（Fluid Audio, UK / Beyond Boundary Music, 2026）——武満徹の1961年のピアノ曲への応答として、音と音の「間」を実際の空間へ拡張した——、『千の集い』（Dragon\'s Eye, 2024）、『Look Up at the Stars』（Youngbloods, 2023）ほか。国立台南大学（台湾）および ESP エンタテインメント東京で講師を務め、アピチャッポン・ウィーラセタクン氏の多摩美術大学ワークショップに講師として参加。',
  ...
  zh: {
    ...
    aboutP3: '發行作品包括《Piano Distance》（Fluid Audio, UK / Beyond Boundary Music, 2026）——回應武滿徹1961年的鋼琴獨奏曲，將音與音之間的「間」延伸為真實空間——、《千の集い》（Dragon\'s Eye, 2024）、《Look Up at the Stars》（Youngbloods, 2023）等。於國立臺南大學（臺灣）與 ESP Entertainment Tokyo 擔任講師，並以講師身分參與 Apichatpong Weerasethakul 在多摩美術大學的工作坊。',
