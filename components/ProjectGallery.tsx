  ...
  return (
    <section ref={targetRef} className="relative h-[300vh] text-[#1a1a1a]">
      <div className="sticky top-0 flex h-screen items-center overflow-hidden perspective-[2000px]">
        ...
        <div className="absolute top-12 left-12 z-10 mix-blend-darken text-[#1a1a1a]">
             <h2 className="text-4xl md:text-6xl font-serif italic tracking-tight text-[#1a1a1a]">
                <ScrambleText text="Selected Works" />
             </h2>
             <div className="w-12 h-[2px] bg-[#1a1a1a] mt-4 mb-2"></div>
             <p className="text-xs font-mono opacity-60 uppercase tracking-widest text-[#1a1a1a]">Audio / Visual Archive 2023 — 2024</p>
        </div>

        <motion.div style={{ x }} className="flex gap-12 md:gap-32 pl-[20vw] items-center transform-style-3d">
    ...
    >
      ...
      <div className="absolute -top-16 left-0 overflow-hidden pointer-events-none font-mono">
        <motion.div
           ...
           className="text-4xl font-bold text-[#a0a0a0] opacity-40"
        >
